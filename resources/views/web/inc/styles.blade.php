...
<link rel="stylesheet" href="{{ asset('assets/web') }}/css/service-main-redesign.css">
<link rel="stylesheet" href="{{ asset('assets/web') }}/css/details-redesign.css">
<link rel="stylesheet" href="{{ asset('assets/web') }}/css/cartpage.css">
<link rel="stylesheet" href="{{ asset('assets/web') }}/css/shop-page.css">
